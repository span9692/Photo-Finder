...
module.exports = {
  up: (queryInterface, Sequelize) => {
   ...
   return queryInterface.bulkInsert('Photos', [
     ...
     {portfolioId: 8, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758180/AllPhoto%20PhotoFinder/family%20photos/5db0e6b52e9d1.image_swzmlx.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 8, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758180/AllPhoto%20PhotoFinder/family%20photos/buckinghamshire-family-photographer.-summer-photoshoots_ugeks5.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 12, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636757805/AllPhoto%20PhotoFinder/pet%20photos/Orpignton-London-pet-photoshoot_kz9dkc.jpg', type: 'pet', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 13, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636757805/AllPhoto%20PhotoFinder/pet%20photos/IMG_6002-1440x960_r53w2u.jpg', type: 'pet', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 13, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636757806/AllPhoto%20PhotoFinder/pet%20photos/80s_Fashion_Pet_Photoshoot_Corgi_Dog_Los_Angeles_Photographer_Miranda_Kelton_Photography-10_gt2xdj.jpg', type: 'pet', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 14, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636757806/AllPhoto%20PhotoFinder/pet%20photos/best_dog_photography_in_Boulder_006_h6sfro.jpg', type: 'pet', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 14, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636757806/AllPhoto%20PhotoFinder/pet%20photos/Otto_Family_Photoshoot-112_n9fnnb.jpg', type: 'pet', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 17, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758180/AllPhoto%20PhotoFinder/family%20photos/family_picture_ideas_on_the_beach_c2jxuy.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 17, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758181/AllPhoto%20PhotoFinder/family%20photos/Family059a_hijhfy.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 17, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758183/AllPhoto%20PhotoFinder/family%20photos/0005Audrey_Benson_Family_Portraits_PF-02-copy_od9yaq.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 18, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758181/AllPhoto%20PhotoFinder/family%20photos/Family060a_rkgo4j.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 19, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758182/AllPhoto%20PhotoFinder/family%20photos/nyejah-bolds-photography-family-portrait-posing-2_amqiqc.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     {portfolioId: 19, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758182/AllPhoto%20PhotoFinder/family%20photos/0021-C_MiniShoot_dntq47.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
     ...
     {portfolioId: 20, url: 'https://res.cloudinary.com/photofinder/image/upload/v1636758183/AllPhoto%20PhotoFinder/family%20photos/20200916011218-180223_Lauren_F1-114_ecroge.jpg', type: 'family', createdAt: new Date(), updatedAt:new Date()},
    ], {});
  },
