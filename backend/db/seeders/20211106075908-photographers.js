...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    return queryInterface.bulkInsert('Photographers', [
      {firstName:'Nick', lastName:'Vu', biography:'Hello! I\'m Nick. Born and raised in San Jose, California, I started taking pictures in my first year of my undergrad!', city:'San Jose', state:'California', price: 75, createdAt: new Date(), updatedAt:new Date()},
